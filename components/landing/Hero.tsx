  ...
  return (
    <section className="relative isolate overflow-hidden bg-[#f4f1eb] text-[#101b2d] dark:bg-[#08111f] dark:text-white lg:min-h-[92svh]">
      <div className="relative z-0 h-[clamp(14rem,68vw,21rem)] w-full bg-[#e9e5dc] dark:bg-[#07101d] lg:absolute lg:inset-y-0 lg:end-0 lg:h-full lg:w-[58%]">
        <ThemeVideoBackground darkSrc={LANDING_MEDIA_CONFIG.hero.dark} lightSrc={LANDING_MEDIA_CONFIG.hero.light} fallbackSrc={LANDING_MEDIA_CONFIG.hero.darkPoster} lightFallbackSrc={LANDING_MEDIA_CONFIG.hero.lightPoster} imageClassName="object-contain object-center lg:object-cover" videoClassName="object-contain object-center lg:object-cover" />
        <div className="absolute inset-0 bg-gradient-to-b from-transparent via-transparent to-[#f4f1eb]/35 dark:to-[#08111f]/35 lg:bg-gradient-to-r lg:from-[#f4f1eb] lg:via-[#f4f1eb]/25 lg:to-transparent dark:lg:from-[#08111f] dark:lg:via-[#08111f]/30 rtl:lg:bg-gradient-to-l" />
      </div>
